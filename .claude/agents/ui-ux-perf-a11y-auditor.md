...
- **Typography**:
  - Page titles: `text-[15px] font-semibold tracking-[-0.04em]`
  - Section labels: `sm:text-sm text-xs font-semibold text-muted-foreground/70 tracking-[-0.04em] uppercase`
...
- **DrawerView** (read-only): Use `DrawerViewShell` or `ResponsiveModal`. No footer. `DrawerTitle` = `text-[15px] font-semibold tracking-heading`.
